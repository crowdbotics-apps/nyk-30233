...
admin.site.site_header = "Nyk"
admin.site.site_title = "Nyk Admin Portal"
admin.site.index_title = "Nyk Admin"

# swagger
api_info = openapi.Info(
    title="Nyk API",
    default_version="v1",
    description="API documentation for Nyk App",
)
